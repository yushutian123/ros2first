...
bool base_interfaces_demo__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.msg._num.Num", full_classname_dest, 33) == 0);
  }
  base_interfaces_demo__msg__Num * ros_message = _ros_message;
  {  // num1
...
PyObject * base_interfaces_demo__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.msg._num");
