...
static const _AddInts_Event_type_support_symbol_names_t _AddInts_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces_demo, srv, AddInts_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, base_interfaces_demo, srv, AddInts_Event)),
  }
};
...
{
  return &::base_interfaces_demo::srv::rosidl_typesupport_cpp::AddInts_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, base_interfaces_demo, srv, AddInts_Event)() {
  return get_message_type_support_handle<base_interfaces_demo::srv::AddInts_Event>();
}
...
static const rosidl_service_type_support_t AddInts_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<base_interfaces_demo::srv::AddInts_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<base_interfaces_demo::srv::AddInts_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<base_interfaces_demo::srv::AddInts_Event>(),
